...
const inputStyle = {
  width: '100%', padding: '8px 12px', background: 'var(--panel)', border: '1px solid var(--line)',
  color: 'var(--ink)', fontSize: 13, fontFamily: 'var(--font-mono)', boxSizing: 'border-box',
};

Object.assign(window, { PersonasSection, OnboardSection, BattleDetail, RulesSection, ArenaSection });
